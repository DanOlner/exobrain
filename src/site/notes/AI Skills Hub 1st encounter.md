...
![Screenshot 2026-01-31 at 02.43.15.png](/img/user/Attachments/Screenshot%202026-01-31%20at%2002.43.15.png)

And I've gone for the experienced professional option. Let's see what it brings up...

![Pasted image 20260131025311.png](/img/user/Attachments/Pasted%20image%2020260131025311.png)
...
I am now on the Hartree Centre's training portal moodle log-in page. I do not have a login. It has no other information there. The top left link just goes back to this log-in page, as does the site's root at [hartreetraining.stfc.ac.uk](hartreetraining.stfc.ac.uk). Well, I am a data professional, maybe it's a test! Let's use those advanced skills of mine and google it.

Ah ha, well done google, [here's](https://www.hartree.stfc.ac.uk/training-skills/training-opportunities/self-paced-learning/page/3/) the Hartree Centre 'create a free account' link. It's run by the Science and Technologies Facility Council - new to me, I confess. And [their own 'uncertainty quantification' page](https://www.hartree.stfc.ac.uk/opportunities/self-learning/2023/06/22/fundamentals-of-uncertainty-quantification-modelling-real-problems-with-uq/) actually reads like a human wrote it. I still don't know how it does or doesn't overlap with stats / ML but it does say "**Pre-requisites:** An understanding of the basic concepts of probability and statistics."
...
Sidequest: at the bottom of the skills hub, one of the things listed alongside Innovate UK as involved is something called 'bridgeAI'. Rather tricky to track down but appears to be an Innovate UK programme. All I've found is [this fosstodon link](https://fosstodon.org/@KirstieJane/113549882343024603#:~:text=BridgeAl%20Partner%20Showcase%20On%20the%20panel:%20Alexandra,Institute%20Dominica%20D'Arcangelo%20%2D%20Alan%20Turing%20Institute). Gonna have to zoom in on that slide... 

![Pasted image 20260131034345.png](/img/user/Attachments/Pasted%20image%2020260131034345.png)

Ah, there are some of the course providers I've just been looking at.

Ah ha, found the [actual site](https://iuk-business-connect.org.uk/programme/bridgeai/). It's not very googleable term, turns out. And look, it's those sectors again! They weren't random!

> "Our mission is to help businesses in high growth potential sectors such as [agriculture and food processing](https://iuk-business-connect.org.uk/agrifood), [construction](https://iuk-business-connect.org.uk/infrastructure/), [creative](https://iuk-business-connect.org.uk/creative-industries/) and [transport, logistics and warehousing](https://iuk-business-connect.org.uk/transport) industries, to harness the power of AI and unlock their full potential."
...
Also, I clicked on the [agri link](https://iuk-business-connect.org.uk/agrifood). That picture of lettuces and robot arms... Oh OK, [stock image](https://tineye.com/search/31466956366ef9fe1924c6e8ce548f6348598a24?tags=stock&sort=score&order=desc&page=1). I need to pull out of this rabbit hole.

BridgeAI have what [they call](https://iuk-business-connect.org.uk/programme/bridgeai/) an 'AI Adoption Framework' "designed to assist you in navigating the complex journey of adopting AI". The page has this image. This is definitely what "doing AI" looks like in the mind of most politicians, I think.

![Pasted image 20260131035604.png](/img/user/Attachments/Pasted%20image%2020260131035604.png)
